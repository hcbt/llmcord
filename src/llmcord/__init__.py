...
discord_bot = commands.Bot(
    intents=intents,
    activity=discord.CustomActivity(name="github.com/jakobdylanc/llmcord"),
    command_prefix=None,
)
...
def initialize_runtime(config_file: str = "config.yaml") -> None:
    global config
    global curr_model
...
async def main_async(config_file: str = "config.yaml") -> None:
